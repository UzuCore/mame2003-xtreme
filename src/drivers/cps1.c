...
static MACHINE_DRIVER_START( sf2 )
	...
	// Lets add our Street Fighter II music samples.
	MDRV_SOUND_ATTRIBUTES(SOUND_SUPPORTS_STEREO)
...
GAME( 1988, daimakaik,ghouls,   cps1,     daimakai, cps1,     ROT0,   "Capcom", "Dai Makai-Mura (Korean Translation)" )			// Wed.26.10.1988 in the ROMS
...
GAME( 1989, striderk, strider,  cps1,     strider,  cps1,     ROT0,   "Capcom", "Strider Hiryu (Korean Translation)" )
...
GAME( 1989, ffightaek,ffight,   ffight_hack,     ffightae, cps1,     ROT0,   "bootleg", "Final Fight 30th Anniversary Edition (Korean Translation)" )
...
GAME( 1995, rockmank, megaman,  cps1,     megaman,  cps1,     ROT0,   "Capcom", "Rockman - The Power Battle (CPS1 Korean Translation 950922)" )
