...
INPUT_PORTS_START( ssf2 )
    ...
    PORT_START      /* IN1 (0x10) */
    PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 ) /* weak kick */
    PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER1 ) /* medium kick */
    PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON5 | IPF_PLAYER1 ) /* fierce kick */
    PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_UNKNOWN )
...
ROM_START( ffightaec2 )
	...
	ROM_REGION( 0x1000000, REGION_GFX1, 0 )
	ROM_LOAD64_WORD( "ff-5m.7a", 0x0000000, 0x400000, CRC(3f4028c5) SHA1(4a4cf19422f4f0fc66ce18ea082320c5adb59750) )
	ROM_LOAD64_WORD( "ff-7m.9a", 0x0000002, 0x400000, CRC(be3858b0) SHA1(ec9e1be10bba4c3b8bf35fca821cd7f4025dfb4a) )
	ROM_LOAD64_WORD( "ff-1m.3a", 0x0000004, 0x400000, CRC(ed622314) SHA1(f7155a41d4fdbcdd4e626b86de18c391125298e3) )
	ROM_LOAD64_WORD( "ff-3m.5a", 0x0000006, 0x400000, CRC(d65b53e9) SHA1(6df4aa177a38407814a35a3560da4e9c301b3fa0) )
...
ROM_START( ffightaec2k )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )  /* 68000 code */
	ROM_LOAD16_WORD_SWAP( "ffk-23m.8h", 0x000000, 0x80000, CRC(1121b009) SHA1(3c5db95773b3f563a3d397ef630838d3d37e0dfd) )
	ROM_LOAD16_WORD_SWAP( "ff-22m.7h",  0x080000, 0x80000, CRC(3615cfb9) SHA1(f83ebdb084505b3c35513f40666ad828846339d2) )

	ROM_REGION( 0x1000000, REGION_GFX1, 0 )
	ROM_LOAD64_WORD( "ffk-5m.7a", 0x0000000, 0x400000, CRC(4f08cd2d) SHA1(190ddd3b0f4ec35f2c1ec879adb08ed20489b15e) )
	ROM_LOAD64_WORD( "ffk-7m.9a", 0x0000002, 0x400000, CRC(780f6593) SHA1(fbb2d7ea5518e7f91eaa11e522312faa021459b4) )
	ROM_LOAD64_WORD( "ffk-1m.3a", 0x0000004, 0x400000, CRC(9d2ac6fc) SHA1(59d0673ca515e81cf26ed394e1ca12ededce486a) )
	ROM_LOAD64_WORD( "ffk-3m.5a", 0x0000006, 0x400000, CRC(106c6eca) SHA1(2cefc946d3aca96d823ad37472f594df3382888f) )
...
GAME( 1993, ddtodk,   ddtod,   cps2, ddtod,   cps2, ROT0,   "Capcom", "Dungeons & Dragons: Tower of Doom (Korean Translation 940412)")
...
GAME( 1994, avspk,    avsp,    cps2, avsp,    cps2, ROT0,   "Capcom", "Alien vs. Predator (Korean Translation 940520)")
...
GAME( 1995, sfzk,     sfa,     cps2, ssf2,    cps2, ROT0,   "Capcom", "Street Fighter Zero (Korean Translation 950727)")
...
GAME( 1996, ddsomk,   ddsom,   cps2, ddtod,   cps2, ROT0,   "Capcom", "Dungeons & Dragons: Shadow over Mystara (Korean Translation 960619)" )
...
GAME( 1995, rmancp2k, megaman, cps2, sgemf,   cps2, ROT0,   "Capcom", "Rockman: The Power Battle (CPS2, Korean Translation 950922)")
...
GAME( 1996, sfz2k,    sfa2,    cps2, ssf2,    cps2, ROT0,   "Capcom", "Street Fighter Zero 2 (Korean Translation 960430)")
...
GAME( 1996, sfz2alk,  sfz2al,  cps2, ssf2,    cps2, ROT0,   "Capcom", "Street Fighter Zero 2 Alpha (Korean Translation 960805)")
...
GAME( 1996, spf2xk,   spf2t,   cps2, 19xx,    cps2, ROT0,   "Capcom", "Super Puzzle Fighter II X (Korean Translation 960531)")
...
GAME( 1997, csclubk,  csclub,  cps2, sgemf,   cps2, ROT0,   "Capcom", "Capcom Sports Club (Korean Translation 970722)")
...
GAME( 1997, pfghtk,   sgemf,   cps2, sgemf,   cps2, ROT0,   "Capcom", "Pocket Fighter (Korean Translation 970904)")
