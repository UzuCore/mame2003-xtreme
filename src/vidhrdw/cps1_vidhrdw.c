...
static struct CPS1config cps1_config_table[]=
{
	...
	{"daimakaik",CPS_B_01, 0,0,0, 0x0000,0xffff,0x0000,0xffff, 1 },
	...
	{"striderk",CPS_B_01, 1,0,1, 0x0000,0xffff,0x0000,0xffff },
	...
	{"ffightk", CPS_B_05, 0,0,0, 0x0001,0xffff,0x0001,0xffff },
	...
	{"area88ka",CPS_B_11, 0,0,0, 0x0000,0xffff,0x0001,0xffff },	/* CPSB ID not checked, but it's the same as sf2eg */
	{"area88kb",CPS_B_11, 0,0,0, 0x0000,0xffff,0x0001,0xffff },	/* CPSB ID not checked, but it's the same as sf2eg */
	...
	{"wonder3k",BATTRY_1, 0,1,0, 0x0000,0xffff,0x0000,0xffff, 2 },
	...
	{"kodk",    BATTRY_2, 0,0,0, 0x0000,0xffff,0x0000,0xffff },
	...
	{"captcomk",BATTRY_3, 0,0,0, 0x0000,0xffff,0x0000,0xffff },
	...
	{"wofk103", QSOUND_1, 0,0,0, 0x0000,0xffff,0x0000,0xffff },
	...
	{"dinok",   QSOUND_2, 0,0,0, 0x0000,0xffff,0x0000,0xffff },	/* layer enable never used */
	...
	{"punishrk",QSOUND_3, 0,0,0, 0x0000,0xffff,0x0000,0xffff },
	...
	{"sfzchk",  NOBATTRY, 0,0,0, 0x0000,0xffff,0x0000,0xffff },
	#endif
